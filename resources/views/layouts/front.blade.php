                ...
                <div class="col-lg-8 col-md-6 col-12">
                    <div class="nav-inner">
                        ...
                        <form action="{{ URL::current() }}" method="get" class="d-flex justify-content-between mb-4">
                            <x-form.input name="title" type=hidden  class="mx-2" :value="request('title')" />

                            <div class="mega-category-menu">
                                <span class="cat-button"><i class="lni lni-menu"></i>All Categories</span>
                                <ul>
                                    <x-form.select name="category_id" class="form-control form-select"
                                        :options="$categories">
                                    </x-form.select>
                                </ul>
                                <button class="btn btn-bg btn-outline-success mr-2">Filter</button>
